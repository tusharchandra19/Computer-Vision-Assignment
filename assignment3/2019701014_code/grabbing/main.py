...
if __name__ == '__main__':
    ...
    # print documentation
    print(__doc__)
    BBOX_DIR = "C:/Users/Tushar/Computer Vision/grabcut/grabbing/bboxes/"
    BBOX_EXT = ".txt"
    DATA_DIR = "C:/Users/Tushar/Computer Vision/grabcut/grabbing/data/images/"
    DATA_EXT = ".jpg"
    ...
    for image_name in image_names:
        ...
        rect = map(int, bbox_file.readlines()[0].strip().split(" "))
        print(rect)
        img = cv.imread(DATA_DIR + image_name + DATA_EXT)
        img2 = img.copy()                                    
        ...
        while(1):
            ...
            if k == 27:         # esc to exit
                ...
                cv.imwrite('C:/Users/Tushar/Computer Vision/grabcut/GrabCut-master/outputgrabcut_output'+str(i)+'.png', res)
